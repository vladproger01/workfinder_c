...
export default function SignUp() {
  ...
  const [accountType, setAccountType] = useState("is_student");
            ...
            <FormControl isRequired>
              ...
              >
                <Stack spacing={5} direction="row">
                  <Radio colorScheme="blue" value="is_student">
                    Студент
                  </Radio>
                  <Radio colorScheme="blue" value="is_company">
                    Компания
                  </Radio>
                </Stack>
              </RadioGroup>
